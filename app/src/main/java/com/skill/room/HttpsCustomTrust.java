...
/**
 * Created by eviewlake on 2018/5/27.
 */
...
public final class HttpsCustomTrust {

    public final X509TrustManager trustManager;
    public final SSLSocketFactory sslSocketFactory;

    public HttpsCustomTrust() {
        try {
            InputStream ddd= trustedCertificatesInputStream();
            trustManager = trustManagerForCertificates(ddd);
...
//                "-----END CERTIFICATE-----";
        ...
        "A4GNADCBiQKBgQC2kchMe9aRAsqxmIQefVQTTYQcI93PYc+aCY426VPTShCT4iFY\n"+
        "dt41Tpog+nixy8+NzFs7lluUmezbc+v36TrrfdvbfpffBDU91X4G5fs9MYE44zKl\n"+
        "w3qTJAVDmw6ICz9kDqnQV8N9UPpUz3RPK41TJI4lu26Zm3nBV3+reRMxswIDAQAB\n"+
        "oAAwDQYJKoZIhvcNAQELBQADgYEAFMxt1zOZF7Vou9THZqG4YxSMBFYu8LT8lFMg\n"+
                "+InzW69uPF79Ms1tdzKLWov82lGxlEc3WeJoHRtn2zYdE5wnU0GuyRklyqf5YTU2\n"+
        "Kqj/o/P18Rr/6kUDsuRuw7mxg7EQ9qFtpqA8pAkTKaGnWdNMMAYfG+IfH0IFDTFw\n"+
        "XYKLGH8=\n"+
                "-----END CERTIFICATE -----";
